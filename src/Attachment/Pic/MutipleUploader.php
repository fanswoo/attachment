...
use FF\Attachment\Pic\Uploader;
use FF\Attachment\Pic\Contracts\MutipleUploader as IMutipleUploader;
...
//            $uploader = clone unserialize(serialize($this->uploader));
    ...
    public function upload(): bool
    {
        foreach ($this->uploaders as $key => $uploader) {
            $uploader->setPicClassName(request()->input('relatedPicName'));
